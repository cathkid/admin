<template>
  <div align="center">
  	  ...
  	  <el-table  v-loading="loading"  :data="tableData" border style="width: 100% overflow: hidden ">
		    ...
		    <el-table-column  prop="option" label="修改"> </el-table-column>
  ...
  export default {
    ...
    methods:{
      ...
      searchIp:function(){
        ...
        var params = new URLSearchParams() 
        params.append('status', 'searchlog')
